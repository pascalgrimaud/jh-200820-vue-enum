<template>
  <div>
    ...
    <div class="table-responsive" v-if="!updatingMetrics && isObjectExistingAndNotEmpty(metrics, 'databases')">
      <table class="table table-striped">
        <caption>Connection pool</caption>
        <thead>
          <tr>
            <th scope="col">
    ...
    <b-modal ref="metricsModal" size="lg">
      <h4 slot="modal-title" class="modal-title" id="showMetricsLabel">
        Threads dump</h4>
